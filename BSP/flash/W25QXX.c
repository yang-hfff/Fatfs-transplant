...
/*******************************************************************************
* Function Name  : SPI_FLASH_SectorErase扇区擦除
...
/*******************************************************************************
* Function Name  : SPI_FLASH_BulkErase全擦
...
/*******************************************************************************
* Function Name  : SPI_FLASH_PageWrite页写
...
/*******************************************************************************
* Function Name  : SPI_FLASH_BufferWrite写一个字符
...
/*******************************************************************************
* Function Name  : SPI_FLASH_BufferRead读字符串
...
/*******************************************************************************
* Function Name  : SPI_FLASH_ReadID读ID
...
{ 
	...
	SPI_FLASH_WaitForWriteEnd();						//等待空闲
 	SPI_FLASH_CS_LOW();
	SPI_FLASH_SendByte(W25X_ReadData);	//发送读数据指令
	SPI_FLASH_SendByte(addr>>16);			//发送24位地址的最高8位
	SPI_FLASH_SendByte(addr>>8);			//发送24位地址的中间8位
	SPI_FLASH_SendByte(addr);			    //发送24位地址的最低8位
	for(i=0; i<num; i++)
